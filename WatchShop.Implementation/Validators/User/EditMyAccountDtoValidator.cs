...
{
    public class EditMyAccountDtoValidator : AbstractValidator<EditMyAccount>
    {
        private readonly AspContext _ctx;
        private readonly IApplicationActor _actor;
        public EditMyAccountDtoValidator(IApplicationActor actor, AspContext ctx)
        {
            _actor = actor;
            _ctx = ctx;
            ...
            RuleFor(x => x.Username).NotEmpty()
                                ...
                                .Must((dto, username) => !IsUsernameInUse(_actor.Id, username))
